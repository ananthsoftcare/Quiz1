...
export default function Content() {
  ...
  const pathname = usePathname();
    ...
    }}> <Rating/>&nbsp;<a href="#introduction">Introduction
									</a></li>
									<li style={{ display: "flex",
        justifyContent: "start",gap:"5px",
