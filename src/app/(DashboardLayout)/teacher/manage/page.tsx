                      ...
                      {visibleRows.map((row, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {row.status === "Lagging" ? <span style={{backgroundColor:"#faf0f3",color:"#db5b7b"}} className='pill'>{row.status}</span>:
                             row.status === "On Track" ? <span style={{backgroundColor:"#f0f1fa",color:"#50537a"}} className='pill'>{row.status}</span>:
                             row.status === "Excelling" ? <span style={{backgroundColor:"#e1fcef",color:"#62af89"}} className='pill'>{row.status}</span>:""}
                              </TableCell>
