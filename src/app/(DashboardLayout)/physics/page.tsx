					...
					<div className='main'>
						<div className='scrollcontent' >
							...
							<section id="request-response">
								<h2 style={{ fontSize: "16px" }}>Laws of Motions</h2>
								<div>
							...
							<section id="authentication">
								<h2 style={{ fontSize: "16px" }}>Newton’s laws </h2>
								<p>
							...
							<section id="links">
								<h2 style={{ fontSize: "16px" }}>Conservation of energy</h2>
								<p>
							...
							<section id="expanders">
								<h2 style={{ fontSize: "16px" }}>Gravity</h2>
								<p>
							...
							<section id="filters">
								<h2 style={{ fontSize: "16px" }}>Mass versus weight</h2>
								<p>
						...
						<nav className="section-nav scrollcontent">
							<ol>
								...
								<li><a href="#request-response">Laws of Motions</a></li>
								<li><a href="#authentication">Newton’s laws </a></li>
								...
								<li className=""><a href="#links">Conservation of energy</a></li>
								<li className=""><a href="#expanders">Gravity</a></li>
								<li className=""><a href="#filters">Mass versus weight</a></li>
							</ol>
