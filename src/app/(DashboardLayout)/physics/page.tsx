...
export default function Content() {
	...
	<form method="post" >
        ...
        justifyContent: "start",gap:"5px",
								...
								<li style={{ display: "flex",
        justifyContent: "start",gap:"5px",
    }}> <Rating/>&nbsp;<a href="#request-response">Laws of Motions</a></li>
								<li style={{ display: "flex",
        justifyContent: "start",gap:"5px",
    }}> <Rating/>&nbsp;<a href="#authentication">Newton’s laws </a></li>
        ...
        justifyContent: "start",gap:"5px",
								...
								<li className="" style={{ display: "flex",
        justifyContent: "start",gap:"5px",
    }}> <Rating/>&nbsp;<a href="#links">Conservation of energy</a></li>
								<li className="" style={{ display: "flex",
        justifyContent: "start",gap:"5px",
    }}> <Rating/>&nbsp;<a href="#expanders">Gravity</a></li>
								<li className="" style={{ display: "flex",
        justifyContent: "start",gap:"5px",
    }}> <Rating/>&nbsp;<a href="#filters">Mass versus weight</a></li>
							</ol>
