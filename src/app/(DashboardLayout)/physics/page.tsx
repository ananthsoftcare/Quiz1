...
<BootstrapDialog
      ...
      >
		...
		<StarBorderSharpIcon  style={{width:"20px",height:"20px",color:"grey"}} onClick={() => handleopenModal()}/>
								...
								<li ><a href="#request-response"  style={{ display: "flex", alignItems: "center", justifyContent: "start", width: "100%" }}> <span>Laws of Motions</span> <div className="rating-icon">
		<StarBorderSharpIcon  style={{width:"20px",height:"20px",color:"grey"}} onClick={() => handleopenModal()}/>
    </div></a></li>
								<li ><a href="#authentication"  style={{ display: "flex", alignItems: "center", justifyContent: "start", width: "100%" }}> <span>Newton’s laws</span> <div className="rating-icon">
		<StarBorderSharpIcon  style={{width:"20px",height:"20px",color:"grey"}} onClick={() => handleopenModal()}/>
    </div> </a></li>
		...
		<StarBorderSharpIcon  style={{width:"20px",height:"20px",color:"grey"}} onClick={() => handleopenModal()}/>
								...
								<li className="" ><a href="#links"  style={{ display: "flex", alignItems: "center", justifyContent: "start", width: "100%" }}> <span>Conservation of energy</span> <div className="rating-icon">
		<StarBorderSharpIcon  style={{width:"20px",height:"20px",color:"grey"}} onClick={() => handleopenModal()}/>
    </div></a></li>
								<li className="" ><a href="#expanders"  style={{ display: "flex", alignItems: "center", justifyContent: "start", width: "100%" }}> <span>Gravity</span> <div className="rating-icon">
		<StarBorderSharpIcon  style={{width:"20px",height:"20px",color:"grey"}} onClick={() => handleopenModal()}/>
    </div></a></li>
								<li className="" ><a href="#filters"  style={{ display: "flex", alignItems: "center", justifyContent: "start", width: "100%" }}> <span>Mass versus weight</span> <div className="rating-icon">
		<StarBorderSharpIcon  style={{width:"20px",height:"20px",color:"grey"}} onClick={() => handleopenModal()}/>
    </div></a></li>
							</ol>
