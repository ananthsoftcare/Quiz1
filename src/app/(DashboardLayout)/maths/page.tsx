	...
	return (
		<div className='mainpage' style={{ position: "fixed", width: "80%" }} >
			...
			<PageContainer title="Content" description="this is Content">
				<b style={{ justifyContent: "center", fontSize: "23px", alignItems: "center", padding: "7px", display: "flex" }}>Maths</b>
					...
					<div className='main'>
						<div className='scrollcontent' >
							...
							<section id="analytical-essay">
								<h2 style={{ fontSize: "16px" }}>Analytical Essay</h2>
							...
							<section id="argumentative-essay">
								<h2 style={{ fontSize: "16px" }}>Argumentative Essay</h2>
								<p>
							...
							<section id="deductive-essay">
								<h2 style={{ fontSize: "16px" }}>Deductive Essay</h2>
								<p>
							...
							<section id="expanders">
								<h2 style={{ fontSize: "16px" }}>Research Essay</h2>
								<p>
							...
							<section id="filters">
								<h2 style={{ fontSize: "16px" }}>Composition Essay</h2>
								<p>
