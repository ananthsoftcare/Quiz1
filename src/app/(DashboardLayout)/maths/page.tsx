...
export default function Content() {
	...
	return (
					...
					<div className='borderLink'>
						<div className='main'>
							<div className='scrollcontent' >
								...
								<section id="analytical-essay">
									<h2 style={{ fontSize: "16px", margin: 0 }}>Analytical Essay</h2>
									<div>New Science Text Books are prepared in such a way that they develop childrens observation
								...
								<section id="argumentative-essay">
									<h2 style={{ fontSize: "16px", margin: 0 }}>Argumentative Essay</h2>
									<p>
								...
								<section id="deductive-essay">
									<h2 style={{ fontSize: "16px", margin: 0 }}>Deductive Essay</h2>
									<p>
        ...
        justifyContent: "start",gap:"5px",
									...
									<li style={{ display: "flex",
        justifyContent: "start",gap:"5px",
    }}> <Rating/>&nbsp;<a href="#analytical-essay">Analytical Essay</a></li>
									<li style={{ display: "flex",
        justifyContent: "start",gap:"5px",
    }}> <Rating/>&nbsp;<a href="#argumentative-essay">Argumentative Essay</a></li>
									<li style={{ display: "flex",
        justifyContent: "start",gap:"5px",
    }}> <Rating/>&nbsp;<a href="#authentication">Chemical Basis</a></li>
									<li style={{ display: "flex",
        justifyContent: "start",gap:"5px",
    }}> <Rating/>&nbsp;<a href="#authentication">Evolution</a></li>
									<li style={{ display: "flex",
        justifyContent: "start",gap:"5px",
    }}> <Rating/>&nbsp;<a href="#authentication">Ecology</a></li>
									<li style={{ display: "flex",
        justifyContent: "start",gap:"5px",
    }}> <Rating/>&nbsp;<a href="#authentication">Refrences</a></li>
									<li style={{ display: "flex",
        justifyContent: "start",gap:"5px",
    }}> <Rating/>&nbsp;<a href="#analytical-essay">Analytical Essay</a></li>
									<li style={{ display: "flex",
        ...
        justifyContent: "start",gap:"5px",
									...
									<li className="" style={{ display: "flex",
        justifyContent: "start",gap:"5px",
    }}> <Rating/>&nbsp;<a href="#deductive-essay">Deductive Essay</a></li>
									<li className="" style={{ display: "flex",
        justifyContent: "start",gap:"5px",
    }}> <Rating/>&nbsp;<a href="#expanders">Research Essay</a></li>
									<li className="" style={{ display: "flex",
        justifyContent: "start",gap:"5px",
    }}> <Rating/>&nbsp;<a href="#filters">Composition Essay</a></li>
								</ol>
