...
const ProfitExpenses = () => {
  ...
  return (
    ...
    >
      <Typography style={{ fontSize: 16, fontWeight: 600, color: '#073763', backgroundColor: '', padding: 2, borderRadius: '5px', paddingLeft: 18 }}>Perfromance in enrolled courses</Typography>
