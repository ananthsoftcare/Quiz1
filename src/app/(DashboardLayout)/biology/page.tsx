...
const links = [
	...
	},
	{
		...
		children: [
			...
			{
				name: "Cities Overview",
				id: 4.2,
				link: '#points--cities-overview',
			},
			{
				name: "City Detail",
				id: 4.3,
				link: '#points--city-detail',
			},
			{
				name: "City Config",
				id: 4.4,
				link: '#points--city-config',
			},
			{
				name: "City Spots Overview",
				id: 4.5,
				link: '#points--city-spots-overview',
			},
			{
				name: "City Spot Detail",
				id: 4.6,
				link: '#points--city-spot-detail',
			},
		]
	},
	{
...
export default function Content({ searchParams }: {
	...
	const [collections, setCollections] = React.useState([
		{ id: 1, name: 'Human', selections: [6, 7] },
		{ id: 2, name: 'Nitrogen', selections: [2, 3] },
		{ id: 3, name: 'Flora', selections: [5] }
	])
	const [smoothSelect, setSmoothSelect] = useState(false)
	const [smoothValue, setSmooothValue] = useState({
		id: '',
		name: "",
		selections: []
	})
	...
	return (
		<div>
			<Card sx={{ p: 1, width: 'max(100%,500px)', height: 'max(80%,30px)', mx: 'auto' }}>
				{/* <Box height="100%"> */}
				{/* <button>back</button> */}
          ...
          <span style={{ backgroundColor: "#cfcdcd", color: "#2f2f2f"}} onClick={() => router.push("/teacher/chemistry")} className='pillbutton'  >P2P Queries</span>&emsp;
					...
					<div >
						<div className='borderLink scrollcontent' >
							<div className='main'>
								<div className='scrollcontent'>
									...
									<section id="points">
										...
										<section id="points--cities-overview">
										...
										<section id="points--city-spots-overview">
										...
										<section id="points--city-spot-detail">
								...
								<section id="endpoints--city-icon-detail">
									...
									<section id="humanDigestiveSystem">
