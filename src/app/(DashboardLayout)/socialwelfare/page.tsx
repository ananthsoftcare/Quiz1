...
<BootstrapDialog
      ...
      >
						...
						<div className='main'>
							<div className='scrollcontent' >
								...
								<section id="request-response">
									<h2 style={{ fontSize: "16px", margin: 0 }}>Request &amp; Response</h2>
									<div>
								...
								<section id="authentication">
									<h2 style={{ fontSize: "16px", margin: 0 }}>Authentication</h2>
									<p>
		...
		<StarBorderSharpIcon  style={{width:"20px",height:"20px",color:"grey"}} onClick={() => handleopenModal()}/>
									...
									<li ><a href="#request-response" style={{ display: "flex", alignItems: "center", justifyContent: "start", width: "100%" }}> <span>Request &amp; Response </span> <div className="rating-icon">
		<StarBorderSharpIcon  style={{width:"20px",height:"20px",color:"grey"}} onClick={() => handleopenModal()}/>
    </div> </a></li>
									<li ><a href="#authentication" style={{ display: "flex", alignItems: "center", justifyContent: "start", width: "100%" }}> <span>Authentication </span><div className="rating-icon">
		<StarBorderSharpIcon  style={{width:"20px",height:"20px",color:"grey"}} onClick={() => handleopenModal()}/>
    </div> </a></li>
		...
		<StarBorderSharpIcon  style={{width:"20px",height:"20px",color:"grey"}} onClick={() => handleopenModal()}/>
									...
									<li className="" ><a href="#links" style={{ display: "flex", alignItems: "center", justifyContent: "start", width: "100%" }}> <span>Links </span> <div className="rating-icon">
		<StarBorderSharpIcon  style={{width:"20px",height:"20px",color:"grey"}} onClick={() => handleopenModal()}/>
    </div></a></li>
									<li className="" ><a href="#expanders" style={{ display: "flex", alignItems: "center", justifyContent: "start", width: "100%" }}> <span> Expanders</span> <div className="rating-icon">
		<StarBorderSharpIcon  style={{width:"20px",height:"20px",color:"grey"}} onClick={() => handleopenModal()}/>
    </div></a></li>
									<li className="" ><a href="#filters" style={{ display: "flex", alignItems: "center", justifyContent: "start", width: "100%" }}> <span>Filters </span> <div className="rating-icon">
		<StarBorderSharpIcon  style={{width:"20px",height:"20px",color:"grey"}} onClick={() => handleopenModal()}/>
    </div></a></li>
								</ol>
